...
Look up notes on this and write this down -> either enumerate or tabular, describe the different options and how well they performed\\
What proved to be the main issue with this method was the diffuse imaging part. Finding materials that would allow only diffuse light to be transmitted, while being regular enough to be used is not easy. The use of paper in combination with wax and marker dye did ..... check notes

\subsubsection{Sample mirror path}
