...
\begin{subfigure}[t]{0.3\textwidth}
\centering
\includegraphics[width=\linewidth]{images/TA-explanationProbeAfterPump.png}
...
\begin{equation}
\mathrm{residual} = \sum_{t_i,d_i} \left(ln\left(\lvert\frac{\Delta A(t_i,d_i)}{\Delta A(t=0,d_i)}\rvert\right)- \frac{t_i}{\tau}\right)^2
\end{equation}
