...
\caption{Probe FWHM$_{SHG}$ = \SI{4}{\nano\meter} Flame spectrometer}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[scale=1]{images/spectra/ActonMonochromatorCharacterisation/620nmSpectrumProbe.png}
\caption{620 nm probe, Qmini, FWHM = 36.5 nm}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[scale=1]{images/spectra/2024-02-05/probe_3H_680nm.png}
\caption{680 nm probe, Qmini, Note that the spectrum shown here is as given by the internal Qmini spectrometer of the NOPA, however the true spectrum does not show the periodic reductions in intensity as shown here. It is Gaussian as expected for other examples. The reductions in intensity are consistent in position. FWHM = 24.1 nm}
\end{subfigure}
\begin{subfigure}[b]{\textwidth}
\centering
\includegraphics[scale=1]{images/spectra/2024-02-05/pump_2H_653nm.png}
\caption{653 nm pump, Qmini, FWHM = 22.4 nm}
\end{subfigure}
