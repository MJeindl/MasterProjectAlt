...
\end{enumerate}
 a background plateau, where the probe pulse passes the sample in time ahead of the pump pulse
...
\begin{table}[hbtp]
\caption{Power densities used for wavelength scan\\ At \SI{6500}{\radiance} linearity of measurements to pump power density may already deviate, however it is still used to check for signal response.\label{tab:powersWavScan}
...
Time at start on the y axis corresponds to the starting time of the measurement}
\end{figure}
